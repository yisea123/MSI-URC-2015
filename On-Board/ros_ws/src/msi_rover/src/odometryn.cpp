...
void Read() {
  if (!( p_i.eof() || q_i.eof() || r_i.eof() || ax_i.eof() || ay_i.eof() || az_i.eof() || magx_i.eof() || magy_i.eof() || magz_i.eof() || Vn_i.eof$
    p_i >> p;
    q_i >> q;
    r_i >> r;
    ax_i >> acc(0);
...
void Load() {
  ahrs(1) = Configuration.get<double>("initialState.attitude.yaw");
  ahrs(2) = Configuration.get<double>("initialState.attitude.yaw");
  ahrs(3) = Configuration.get<double>("initialState.attitude.yaw");
  ...
  ahrs(4) = Configuration.get<double>("initialState.gyroscope.bp");
  ahrs(5) = Configuration.get<double>("initialState.gyroscope.bq");
  ahrs(6) = Configuration.get<double>("initialState.gyroscope.br");
